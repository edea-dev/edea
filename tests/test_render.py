...
class TestRendering:
    def test_draw_rect(self):
        ...
        assert expr.draw((0, 0)) == '<rect x="-5.08mm" y="-5.08mm" width="10.16mm" height="6.985mm" />'
    ...
    def test_draw_polyline(self):
        ...
        assert expr.draw((0,
                          0)) == '<polyline points="-5.761,1.92 5.761,1.92 " stroke="rgb(0,0,0)" stroke-opacity="1" stroke-width="0.3048mm" fill="none" />'
    ...
    def test_draw_polyline_outline(self):
        ...
        assert expr.draw((12,
                          0)) == '<polyline points="39.599,1.92 51.121,1.92 " stroke="rgb(0,50,0)" stroke-opacity="0.2" stroke-width="0.3048mm" fill="rgb(0,50,0)" fill-opacity="0.2" />'
